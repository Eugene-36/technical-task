...
/* harmony import */ var _checkOtherForms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkOtherForms */ "./src/js/modules/checkOtherForms.js");
/* harmony import */ var _checkOtherForms__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_checkOtherForms__WEBPACK_IMPORTED_MODULE_1__);
...
const changeModalState = state => {
  ...
  btnNext.disabled = true; //console.log(windowProfile);
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('.checkbox');
...
const checkNumInputs = selector => {
  ...
  numInputs.forEach((item, i) => {
    ...
    item.addEventListener('input', () => {
      item.value = item.value.replace(/\D/, ''); //Если убрать это условие то будет пропускать на пустой строке
...
/***/ "./src/js/modules/checkOtherForms.js":
/*!*******************************************!*\
  !*** ./src/js/modules/checkOtherForms.js ***!
  \*******************************************/
/*! no static exports found */
...
// const btnNext = document.querySelector('.popup_calc_button');
// //btnNext.setAttribute('disabled', 'disabled');
// const windows = document.querySelectorAll('[data-modal]');
// const validationForms = (selector) => {
//   const numInputs = document.querySelectorAll(selector);
//   const calculatorForm = document.querySelectorAll(selector);
//   const firstForm = windows[2];
//   const s = firstForm.getElementsByClassName('.form-control');
//   console.log(s);
//   //firstForm.forEach(item=>console.log();)
...
const timer = (id, deadline) => {
  ...
  const setClock = (selector, endTiem) => {
    ...
    function updateClock() {
      const t = getTimeremaining(endTiem);
